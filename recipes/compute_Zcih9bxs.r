...
tc_names  <- unique(counterfactual_test_data$typhoon)
...
# -------------------------------------------------------------------------------- NOTEBOOK-CELL: CODE
# loop through the counterfactual dataframes to get the mean for each region.

counterfactual_means  <- list()

# loop through all counterfactuals and predict damage
